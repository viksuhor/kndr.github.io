$(document).ready(function() {
  ...
  for (s_tmp = 0; s_tmp < CountQuest; s_tmp++) {
    ...
    slide_cont = slide_cont + "</div></div><div class=\"kndr_rd_sg_btn kndr_rd_sg_btn_r\"><img src=\"https://viksuhor.github.io/image/sld_sg_arrow_right.png\"></div></div></div></div><div class=\'kndr_rd_right_slide\'><div class=\'kndr_rd_questword\'>"+kndr_rd_slides_src[s_tmp].type+"</div><div class=\'kndr_rd_namequest\'><p>" + kndr_rd_slides_src[s_tmp].name + "<span class=\"quest_age\">"+kndr_rd_slides_src[s_tmp].questage+"</span></p></div><div class=\'kndr_rd_quest_dsk\'>" + kndr_rd_slides_src[s_tmp].desk + "</div><div class=\'kndr_rd_cost\'>Стоимость (за 1-го человека в команде):</div><div class= \'kndr_rd_cost_dsk\'>" + kndr_rd_slides_src[s_tmp].cost + "</div><div class=\'knd_rd_block_btns\' onclick=\"showSectionPopup(\'"+wnd_popup+"\');return false;\">Забронировать квест</div></div></div>";
