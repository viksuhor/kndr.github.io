$(document).ready(function() {
  ...
  for (s_tmp = 0; s_tmp < CountQuest; s_tmp++) {
    ...
    slide_cont = slide_cont + "</div></div><div class=\"kndr_rd_sg_btn kndr_rd_sg_btn_r\"></div></div></div></div><div class=\'kndr_rd_right_slide\'><div class=\'kndr_rd_questword\'>КВЕСТ</div><div class=\'kndr_rd_namequest\'><p>" + kndr_rd_slides_src[s_tmp].name + "</p></div><div class=\'kndr_rd_quest_dsk\'>" + kndr_rd_slides_src[s_tmp].desk + "</div><div class=\'kndr_rd_cost\'>Стоимость (за 1-го человека в команде):</div><div class= \'kndr_rd_cost_dsk\'>" + kndr_rd_slides_src[s_tmp].cost + "</div><div class=\'knd_rd_block_btns\'><div ><a act=\"popup\" onclick=\"showSectionPopup(\'76a096de417c4e1390c293e9818fb708\');return false;\" data-action-name=\"popup\" style=\"\">Забронировать квест</a></div></div></div></div>";
